    ...
    public function run(): void
    {
        $embeddingModels = [
            ...
            [
                ...
                'is_active' => true,
                'sort_order' => 4,
                'description' => 'Google Gemini embedding (768d). High-quality multilingual embeddings via Google API.',
            ],
        ];
        ...
        $llmModels = [
            ...
            [
                ...
                'is_active' => true,
                'sort_order' => 5,
                'description' => 'Anthropic Claude Sonnet 4.5 — 200K context, strong reasoning, best-in-class accuracy.',
                'settings' => ['max_tokens' => 4096],
            ...
            [
                ...
                'is_active' => true,
                'sort_order' => 6,
                'description' => 'DeepSeek Chat — 128K context, cost-effective, strong reasoning and coding.',
                'settings' => ['max_tokens' => 4096],
            ...
            [
                ...
                'is_active' => true,
                'sort_order' => 7,
                'description' => 'Google Gemini 2.5 Flash — 1M context, fast and cost-effective multimodal.',
                'settings' => ['max_tokens' => 8192],
            ...
            [
                ...
                'is_active' => true,
                'sort_order' => 8,
                'description' => 'OpenAI GPT-4o — 128K context, multimodal, strong general-purpose reasoning.',
                'settings' => ['max_tokens' => 4096],
